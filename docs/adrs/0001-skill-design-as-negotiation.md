...
- `ixion/skills/ixion-conventions/references/git-branches.md` — the production/integration resolution, the protected set, and the three shared error states, cited by work, work-review and ship. The instance of Principle 8 where the duplicated copies had measurably drifted before extraction.
