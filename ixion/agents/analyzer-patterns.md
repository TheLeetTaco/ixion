...
- `src/services/auth.rs:42-67` - Example of the pattern
...
Location: `path/to/other.rs:15-30`
```rust
// Code showing variation
```

*Variation 2*: [description]
Location: `path/to/another.rs:89-105`

### Usage Context
- Imported from: `path/to/module`
- Used by: `path/to/consumer.rs:42`
- Prerequisites: [setup required]

### Related Patterns
- `path/to/related.rs:42` - [related pattern name]

### Files Analyzed
- `path/to/file.rs` - [contains pattern]
