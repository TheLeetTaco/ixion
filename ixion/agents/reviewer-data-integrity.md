...
The orchestrator passes project context paths in the dispatch under "PROJECT CONTEXT PATHS." Read those paths for project-specific schema rules, migration history, and data sensitivity before reviewing. Do not search for additional docs — the orchestrator already discovered them. If "none," apply universal data-safety principles.
