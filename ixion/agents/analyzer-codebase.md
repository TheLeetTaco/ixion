...
- `src/services/auth.rs:42-67` - AuthService struct handles token validation
- `src/services/auth.rs:89-105` - authenticate() method checks credentials
...
**[Component/Area 1]**
- Location: `path/to/file.rs:42-67`
...
**[Component/Area 2]**
- Location: `path/to/file.rs:100-150`
- Purpose: [what it does]
- Interactions: [how it connects to other components]

### Data Flow
1. [Step 1]: `file.rs:42` → [what happens]
2. [Step 2]: `other.rs:67` → [what happens]

### Dependencies
- `path/to/dep.rs` - [how it's used]
